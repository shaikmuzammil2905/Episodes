      ...
      <header className="header">
        <div className="container header-content">
          ...
          <nav className="desktop-nav desktop-only">
            ...
            <Link href="/genres" className="nav-link">{t('genres')}</Link>
            <Link href="/authors" className="nav-link">{t('authors')}</Link>
            <Link href="/about" className="nav-link">{t('about')}</Link>
          </nav>

          {/* Header Actions */}
          <div className="header-actions">
            <button className="whatsapp-nav-btn" onClick={openWhatsAppModal} title={t('chatOnWhatsApp')}>
            ...
            <a href="tel:8790349941" className="call-btn" title={t('callUs')}>
          ...
          <div className="mobile-menu-overlay">
            <div className="mobile-menu-content">
              <nav className="mobile-nav-links">
                ...
                <Link href="/stories" onClick={() => setMobileMenuOpen(false)}>{t('stories')}</Link>
                <Link href="/genres" onClick={() => setMobileMenuOpen(false)}>{t('genres')}</Link>
                <Link href="/authors" onClick={() => setMobileMenuOpen(false)}>{t('authors')}</Link>
